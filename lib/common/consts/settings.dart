...
/// app versions
const String app_beta_version = '0.9.0-beta.6';

/// js code versions
const Map<String, int> js_code_version_map = {
  network_name_polkadot: 8620,
  network_name_kusama: 8620,
  network_name_acala_mandala: 8620,
  network_name_laminar_turbulence: 8620,
};
