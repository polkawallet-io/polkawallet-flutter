...
function sendTx(params) {
  ...
  var txHandlers = {
    ...
    electionsPhragmen: {
      vote: params =>
        api.tx.electionsPhragmen.vote(params.votes, params.voteValue)
    },
    democracy: {
      vote: params => api.tx.democracy.vote(params.id, params.options)
    }
  };
  return new Promise((resolve, reject) => {
