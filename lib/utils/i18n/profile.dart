const Map<String, String> enProfile = {
  ...
  'recovery.remove.warn': 'Active recoveries detected, you should close them to continue.',
  ...
  'recovery.delay.warn': 'Recommended delay period is 30 days or longer, are you sure to use the customized value?',
...
const Map<String, String> zhProfile = {
  ...
  'about.version': '版本',
  'recovery': '社交恢复',
  'recovery.brief': '通过设置可信的好友账户，将您的账户配置为可恢复账户。\n\n若您的私钥丢失，可通过社交恢复流程在好友账户的帮助下将该账户资产转移至新的账户。',
