...
class Exchange extends StatefulWidget {
  ...
  @override
  _ExchangeState createState() => _ExchangeState(store);
}

class _ExchangeState extends State<Exchange> {
  _ExchangeState(this.store);
  ...
  void _onSubmit() {
    if (_formKey.currentState.validate()) {
      ...
      var args = {
        "title": I18n.of(context).dex['exchange'],
        "txInfo": {
          "module": 'dex',
          "call": 'swapCurrency',
        },
  ...
  Widget build(_) {
    return Observer(
      builder: (BuildContext context) {
        final Map dic = I18n.of(context).dex;
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          decoration: InputDecoration(
                                            hintText: dic['receive'],
                                            labelText: dic['receive'],
                                          ),
                                          inputFormatters: [
                                            RegExInputFormatter.withRegex(
                                                '^[0-9]{0,6}(\\.[0-9]{0,$decimals})?\$')
