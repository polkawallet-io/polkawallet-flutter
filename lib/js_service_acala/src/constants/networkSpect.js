...
export const SubstrateNetworkKeys = Object.freeze({
  ACALA_TC3:
    "0x66854857842bbdbac97b3dbd24ff2e39f75184970bb88e1725e179363132aa6e",
  CENTRIFUGE:
...
const substrateNetworkBase = {
  [SubstrateNetworkKeys.ACALA_TC3]: {
    color: "#173DC9",
    decimals: 18,
    genesisHash: SubstrateNetworkKeys.ACALA_TC3,
    order: 42,
    pathId: "acala_tc3",
    prefix: 42,
    title: "Acala Mandala TC3",
    unit: "ACA",
  },
