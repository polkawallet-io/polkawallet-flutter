...
describe('scale-codec', () => {
  ...
  describe('decode', () => {
    ...
    it('can parse data from wallet when scanning the qr code', async () => {
      ...
      const walletClaim = {
        'claimant_public': '5FLSigC9HGRKVhB9FiEo4Y3koPsNmBmLJbpXg2mp1hXcS59Y',
        'ceremony_index': 2,
        'community_identifier': {
          'geohash': '0x73716d3176',
          'digest': '0xf08c911c'
        },
        'meetup_location_index': 6,
        'location': {
        ...
        'number_of_participants_confirmed': 3,
        'claimant_signature': { 'sr25519': '0x726ba0a4952ea2fc42444e21176209c364f9de420c88bcc04a7196647d482c59d6865fbd14aff779720d0bf0e5a1b951d5d5267b877b29034523fff3994aef8a' }
      };
      ...
      expect(
        signatureVerify(
          ...
          scannedClaim.claimant_signature.unwrap().toU8a(),
          scannedClaim.claimant_public
        ).isValid
      ).toBe(true);
    });
  });
