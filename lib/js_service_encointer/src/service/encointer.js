...
export async function getNextMeetupTime (cid, location) {
  ...
  // TODO: remove the following Gesell-fix to replicate error pre 0.3.4
  // +duration because it seems nextPhaseTimestamp is evaluated after setting REGISTERING in onchain logic
  var mtime = Math.round(start + day - (lon * day / 360) + duration);
